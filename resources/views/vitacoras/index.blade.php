    ...
    @foreach($vitacora_asistencias as $vitacora_asistencias)
        <tr>
            ...
            <form class="eliminar" action="{{route('vitacoras.destroy',$vitacora_asistencias->id)}}" method="POST">
                ...
                <a  class="btn btn-sm btn-primary" target="_blank" href="/vitacoras-download/{{ $vitacora_asistencias->id }}"class="btn float-right mb-4 btn-sm btn-info"><i class="fas fa-print"></i></a>
