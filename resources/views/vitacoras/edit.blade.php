...
@section('title', 'Editar vitacoras')
...
<input type="text" class="form-control p-3 bg-white shadow-sm rounded" value="{{$Vitacora_asistencias->objetivo}}" name="objetivo" required>
</div>

<div class="form-group col-md-6">
<label>Temas abordados</label>
<input type="text" class="form-control p-3 bg-white shadow-sm rounded" value="{{$Vitacora_asistencias->temas_abordados}}" name="temas_abordados"required>
</div>
</div>
...
<input type="text" class="form-control p-3 bg-white shadow-sm rounded" value="{{$Vitacora_asistencias->dificultades}}" name="dificultades" required>
</div>

<div class="form-group col-md-6">
<label>Soluciones</label>
<input type="text" class="form-control p-3 bg-white shadow-sm rounded" value="{{$Vitacora_asistencias->soluciones}}" name="soluciones"required>
</div>
</div>
...
<input type="text" class="form-control p-3 bg-white shadow-sm rounded"  value="{{$Vitacora_asistencias->recomendaciones}}" name="recomendaciones" required>
</div>

<div class="form-group col-md-6">
<label>Fecha de visita</label>
<input type="date" class="form-control p-3 bg-white shadow-sm rounded" value="{{$Vitacora_asistencias->fecha}}" name="fecha" required>
</div>
</div>
