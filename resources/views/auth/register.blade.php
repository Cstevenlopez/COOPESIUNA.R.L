                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id_usuario" type="text" class="form-control @error('name') is-invalid @enderror" name="id_usuario" value="{{ old('name') }}" required autocomplete="id_usuario" autofocus>
