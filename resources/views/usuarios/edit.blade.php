...
<div class="form-row ml-5">
    ...
    <input type="text" style="height: 50px" class="form-control shadow-lg p-3 mb-4 bg-white rounded" value="{{$users->usuario}}" name="usuario" id="usuario" placeholder=""required>
    <div class="valid-feedback">
    </div>
    </div>  
...
<a href="/usuarios" class="btn btn-secondary btn-lg" tabindex="5">Cancelar <i class="fas fa-reply-all"></i></a>
